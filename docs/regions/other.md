...
only large water bodies in England that a reconstruction at a medieval date must show as
**forming**, rather than as later intrusions to be removed.

This is also where the scoping exercise was worst: **the Bure (92.7 km) and 83% of the
Broads unreached**, with a hand-authored connector that attached correctly at both ends
and still carried nothing. **The cause was never found**, and it is on the list for the
rebuild.
...
## The Hull valley and Holderness

Covered by the Humber page's later statutory schemes (Holderness Drainage 1764, Beverley
and Barmston 1798, Keyingham c.1802) and by the Humber Wetlands Project's **Holderness**
volume. Listed separately because its drainage is eighteenth-century rather than
seventeenth, and so belongs to a different documentary record.

## The Severn estuary and the Vale of Berkeley

Coastal reclamation with a long medieval history and a good literature — **Rippon** again,
whose comparative work covers the Severn levels alongside Somerset.

## The Lincolnshire coastal marshes and the Wash silts

The siltland between the Fens proper and the sea, reclaimed progressively from the Roman
period. Relevant to where the medieval coastline actually ran — which this project treats
as a **measurement rather than a filter**: the coast is drawn and reported, and never used
to clip the network.

## The Thames

Not a rebuilt landscape, but worth a line because of scale: tidal reaches, extensive
embankment from the medieval period, and the largest flows in the dataset. The scoping
exercise found tidal reaches to be the class with the **highest rate of flow anomalies** —
4.6% against 0.9% for inland rivers — which is unexplained, and may be a sampling artefact
at the tidal limit rather than a topology fault.
