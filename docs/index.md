...
[the methodology](methodology.md) explains why.
...
| | |
|---|---|
| [Aims](aims.md) | what this will produce, for whom, and in what order |
| [Methodology](methodology.md) | how the network is built, and why the order of work is the finding |
| [Evidence](evidence.md) | the sources, what each can and cannot say, and their licences |
| [Background](background.md) | the proof-of-concept that preceded this, and what it established |
